 ...
 * @LastEditTime: 2021-03-22 11:18:27
 * @LastEditors: h7ml
 * @FilePath: \web\src\config\cdn.config.js
 * @Description:
 */
module.exports = {
  staticUrl: {
    ...
    js: [
      ...
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.9/ace.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.9/mode-json.min.js',
