    ...
    data() {
      return {
        list: [
          {
            image:
              'http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/platform/assets/index_images/image.jpg',
          ...
          /* {
            image: http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/platform/assets/index_images/image.jpg'),
